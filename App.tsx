...
function App() {
  ...
  // Initialize cart from localStorage for better usability
  const [cartItems, setCartItems] = useState<Product[]>(() => {
    try {
      const saved = localStorage.getItem('nworksinc_cart');
  ...
  useEffect(() => {
    localStorage.setItem('nworksinc_cart', JSON.stringify(cartItems));
  }, [cartItems]);
